...
namespace EStateDevelopment.Data
{
    ...
    public partial class BorrowerApplication
    {
        ...
        public BorrowerApplication()
        {
            this.BorrowerDocuments = new HashSet<BorrowerDocument>();
        }
    
        public int BorrowerApplicationID { get; set; }
        ...
        public virtual ICollection<BorrowerDocument> BorrowerDocuments { get; set; }
    }
}
