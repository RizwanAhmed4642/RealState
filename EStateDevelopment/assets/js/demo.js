...
demo = {
        ...
        $calendar.fullCalendar({
            ...
            select: function(start, end) {
                ...
                swal({
                    ...
                    html: '<br><input class="form-control" placeholder="Event Title" id="input-field"><br><input class="form-control" placeholder="Event Title" id="input-field">',
    ...
    showNotification: function(from, align) {
        ...
        $.notify({
            icon: "nc-icon nc-app",
            message: "Welcome to <b>QIGI Application</b> - Developed by Absolute Solutions."
    ...
    showSwal: function(type) {
        if (type == 'basic') {
            ...
            swal({
                    title: 'Please Add Your Question',
